        ...
        <x-page-header title="Folders" subtitle="Organize your shortlinks by campaign">
            <x-slot name="actions">
                <form method="POST" action="{{ route('folders.store') }}" class="flex gap-2">
                    @csrf
                    <input type="text" name="name" placeholder="Folder name..." class="rounded-xl border-gray-200 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-700 dark:bg-gray-800 dark:text-white" required>
